...
**Technologies:** Vue.js, Python, Django, PostgreSQL, WebSockets

### Weather Dashboard
A responsive weather dashboard that displays current weather, forecasts, and historical data for multiple locations.

**Technologies:** JavaScript, Bootstrap, REST API, Chart.js, Local Storage
...
## 🌱 Workflow
- Planning with wireframes and mockups (Figma, Adobe XD)
...
- Learn more about web security best practices
